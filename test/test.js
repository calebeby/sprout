  ...
  function () {
    ...
    describe('add',
      function () {
        it('should add template',
          function (done) {
            apiAdd(sprout, 'foo', 'https://github.com/carrot/sprout-sprout').then(
              function () {
